...
def main():
    ...
    print("Решение методом Монте-Карло :", monte_carlo_solving(1000, 1000, B.copy(), f))     # количество цепей и длина
    print("Решение с помощью numpy     :", rez)
    ...
    print("Нажмите Enter для отображения графиков")
    input()
